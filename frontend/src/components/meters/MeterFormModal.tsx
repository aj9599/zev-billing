import { X, Info, AlertCircle, Wifi, Rss, Cloud, Check, CheckCircle, AlertTriangle } from 'lucide-react';
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            ...
                                            {supportsExport && (
                                                <>
                                                    <br />
                                                    <Check size={16} style={{ display: 'inline', marginRight: '4px', color: '#22c55e' }} />
                                                    {t('meters.loxoneFeature4')}
                                                </>
                                            )}
                                        </div>
                                    </div>
