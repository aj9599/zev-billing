...
import { Plus, Edit2, Trash2, X, HelpCircle, Info, Car, Download, Search, Building, Radio, Settings, Star, Wifi, WifiOff, AlertCircle, AlertTriangle, Zap, Battery, Clock, User, Activity, TrendingUp, Power, Gauge } from 'lucide-react';
          ...
          <div key={buildingId} style={{ marginBottom: '30px' }}>
            ...
            <div className="chargers-grid" style={{
              ...
              {buildingChargers.map(charger => {
                ...
                const live = liveData[charger.id];
                return (
                  <div key={charger.id} className="charger-card-modern" style={{
                    background: live?.state === '67'
                    ...
                    {/* ADD THIS ANIMATED BACKGROUND HERE */}
                    <div style={{
                      position: 'absolute',
                      top: 0,
                      left: 0,
                    ...
                    <div style={{ padding: '24px', background: 'white' }}>
                      ...
                      <div style={{
                        display: 'grid',
                        gridTemplateColumns: live?.session_energy && live.session_energy > 0 ? '1fr 1fr' : '1fr',
                        gap: '16px',
                        marginBottom: '20px'
                      }}>
                        {/* Total Energy Card */}
                      ...
                      {live?.current_power_kw !== undefined && (
                        <div style={{
                          ...
                          <div style={{
                            ...
                            <div>
                              ...
                              <div style={{
                                ...
                                {live.current_power_kw.toFixed(2)}
