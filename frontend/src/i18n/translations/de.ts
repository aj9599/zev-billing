...
export const de: Translations = {
  // ============================================================================
  // E3/DC HAUSKRAFTWERK (Zähler, Ladestation, Gerät)
  // ============================================================================
  'meters.e3dcIntro': 'Liest einen Wert aus einem E3/DC-Hauskraftwerk. Die Leistung wird zur Verrechnung in kumulierte Energie integriert. Modbus (Port 502) ist nur lesend und benötigt keine Anmeldung; RSCP (Port 5033) funktioniert ebenfalls und ist für Wallbox-Werte erforderlich.',
  'meters.e3dcProtocol': 'Protokoll',
  'meters.e3dcProtocolModbus': 'Modbus TCP (nur lesend)',
  'meters.e3dcProtocolRscp': 'RSCP (verschlüsselt)',
  'meters.e3dcValue': 'Wert',
  'meters.e3dcValueGrid': 'Netz (Bezug / Einspeisung)',
  'meters.e3dcValuePv': 'PV-Produktion',
  ...
  'meters.e3dcPassword': 'Portal-Passwort',
  'meters.e3dcRscpKey': 'RSCP-Schlüssel',
  'meters.e3dcRscpKeyHint': 'Am Gerät unter Personalisieren → Benutzerprofil gesetzt (der Verschlüsselungsschlüssel, nicht das Portal-Passwort).',
  'meters.e3dcUnitId': 'Modbus Unit-ID',
  'meters.e3dcUnitIdHint': 'Aktiviere zuerst Modbus/TCP in den E3/DC-Einstellungen. Wallbox-Werte erfordern RSCP.',
  'meters.e3dcExternalPower': 'Zusätzliche Einspeisung abziehen (zweiter Wechselrichter)',
  'meters.e3dcConnected': 'E3/DC verbunden',
  'meters.e3dcDisconnected': 'E3/DC getrennt',
  'meters.e3dcConnecting': 'E3/DC verbindet…',
  'meters.e3dcSoc': 'Ladestand',
  'meters.e3dcCharging': 'lädt',
  ...
  'chargers.e3dcUser': 'Portal-Benutzer (myE3DC E-Mail)',
  'chargers.e3dcPassword': 'Portal-Passwort',
  'chargers.e3dcRscpKey': 'RSCP-Schlüssel',
  'chargers.e3dcRscpKeyHint': 'Am Gerät unter Personalisieren → Benutzerprofil gesetzt. Das ist der Verschlüsselungsschlüssel, NICHT das Portal-Passwort.',
  'devices.e3dcInfo': 'Steuert die integrierte E3/DC-Wallbox über RSCP — «Ein» aktiviert das Laden, «Aus» stoppt es. Deaktiviere im E3/DC-Portal den Sonnenmodus und die automatische Phasenumschaltung, damit diese App steuern kann.',
  'devices.e3dcRscpKey': 'RSCP-Schlüssel',
  'devices.e3dcDynamic': 'Dynamisches Solarladen',
  'devices.e3dcDynamicHint': 'Passt den Wallbox-Strom laufend an den verfügbaren Solarüberschuss an, statt einfach ein/aus. Im Auto-Modus folgt es der Sonne; Ein = mit max. Strom laden, Aus = stoppen.',
  ...
  'devices.setupInstructions': 'Einrichtungs-Anleitung',
  'devices.instructions.title': 'Geräte-Einrichtung',
  'devices.instructions.intro': 'Geräte schalten externe Relais nach dem aktuellen Solarüberschuss. Füge ein Shelly- oder Loxone-Relais hinzu, lege fest, wann es einschalten soll, und das System steuert es im Auto-Modus automatisch.',
  'devices.instructions.shellyTitle': 'Shelly-Relais',
  'devices.instructions.shellyText': 'Wähle dein genaues Shelly-Modell und gib die IP-Adresse ein (sowie Benutzer/Passwort, falls gesetzt). PM-Modelle zeigen zusätzlich Live-Leistung und Energie auf der Karte.\nMehrkanal-Modelle (Pro 2/3/4PM) können als einzelnes Relais oder im «Stufen»-Modus laufen: pro Stufe werden mehr Relais eingeschaltet, je grösser der Überschuss (z. B. Boiler: Stufe 1 = 2 Relais bei 2 kW, Stufe 2 = alle 3 Relais bei 4 kW).',
  'devices.instructions.loxoneTitle': 'Loxone-Relais',
  'devices.instructions.loxoneText': 'Gib die Miniserver-IP und deine Zugangsdaten ein und nutze «Vom Miniserver laden», um den Ausgang nach Namen auszuwählen, statt eine UUID einzutippen. Die Karte zeigt den realen Schaltzustand aus Loxone.',
  'devices.instructions.controlTitle': 'Steuerung & Schwellen',
  'devices.instructions.controlText': 'Lege die Ein-Schwelle (nötiger Überschuss zum Einschalten) und die Aus-Schwelle (Hysterese) fest. Die Priorität bestimmt, welches Gerät den Überschuss zuerst erhält; Mindest-Ein-/Ausschaltzeiten verhindern schnelles Schalten. Mit Ein / Aus / Auto manuell übersteuern — Zeitplan und Laufzeit-Garantie wirken nur im Auto-Modus.',
  'devices.instructions.scheduleTitle': 'Zeitplan',
  'devices.instructions.scheduleText': 'Optionale Zeitfenster schalten das Gerät unabhängig von der Sonne ein (z. B. Boiler 18:00–23:00 warm halten). Nur im Auto-Modus aktiv.',
  'devices.instructions.guaranteeTitle': 'Laufzeit-Garantie',
  'devices.instructions.guaranteeText': 'Garantiere eine Mindestlaufzeit (in Stunden oder Minuten) bis zu einer täglichen Uhrzeit. Reichte die Sonne nicht, läuft das Gerät spät genug aus dem Netz, um die Zeit noch zu erreichen. Nur im Auto-Modus aktiv.',
  ...
  'devices.controlError': 'Befehl konnte nicht an das Gerät gesendet werden.',
  'devices.confirmDelete': 'Gerät "{name}" löschen?',
  'devices.online': 'Online',
  'devices.offline': 'Offline',
  'devices.noSignal': 'Kein Netzsignal',
  'devices.state.on': 'Ein',
  'devices.state.off': 'Aus',
  'devices.state.offline': 'Offline',
  'devices.state.unknown': 'Unbekannt',
  'devices.mode.auto': 'Auto',
  'devices.mode.on': 'Manuell ein',
  'devices.mode.off': 'Manuell aus',
  'devices.modeLabel': 'Modus',
  'devices.deviceShort': 'Gerät',
  'devices.controlShort': 'Steuerung',
  ...
  'devices.auto': 'Auto',
  'devices.name': 'Name',
  'devices.building': 'Gebäude',
  'devices.driver': 'Gerätetyp',
  'devices.connection': 'Verbindung',
  'devices.host': 'IP-Adresse / Host',
  'devices.generation': 'Generation',
  'devices.shellyModel': 'Shelly-Modell',
  'devices.channel': 'Kanal',
  'devices.relay': 'Relais',
  'devices.devicePower': 'Leistung',
  'devices.shellyControlMode': 'Relais-Steuerung',
  'devices.shellySingle': 'Einzelnes Relais',
  'devices.shellyStaged': 'Stufen',
  'devices.stages': 'Stufen',
  'devices.stage': 'Stufe',
  'devices.stageOnThreshold': 'Ein ≥ (W)',
  'devices.stageOffThreshold': 'Aus < (W)',
  'devices.addStage': 'Stufe hinzufügen',
  'devices.stagesHint': 'Stufen sind kumulative Leistungsstufen. Wähle pro Stufe, welche Relais EIN sind; eine Stufe schaltet ein, wenn der Überschuss ihre Ein-Schwelle erreicht, und ab, wenn er unter die Aus-Schwelle fällt. Von der niedrigsten zur höchsten Schwelle ordnen.',
  'devices.authUser': 'Benutzername',
  'devices.authPass': 'Passwort',
  'devices.outputUuid': 'Ausgang-UUID',
  'devices.discover': 'Geräte vom Miniserver laden',
  'devices.discovering': 'Lädt…',
  'devices.pickOutput': 'Ausgang wählen',
  'devices.discoverNeedHost': 'Bitte zuerst die Miniserver-IP eingeben.',
  'devices.discoverEmpty': 'Keine schaltbaren Ausgänge gefunden.',
  'devices.discoverError': 'Geräte konnten nicht vom Miniserver geladen werden.',
  // Loxone Auto-Erkennung (Zähler & Ladestationen)
  'loxone.discoverTitle': 'Auto-Erkennung',
  'loxone.discoverHint': 'Miniserver-IP und Zugangsdaten oben eingeben, dann die Liste laden und den Block nach Namen auswählen — die UUID muss nicht von Hand gesucht werden.',
  'loxone.discoverHost': 'Miniserver-IP',
  'loxone.discover': 'Vom Miniserver laden',
  'loxone.discovering': 'Lädt…',
  'loxone.discoverNeedHost': 'Bitte zuerst die Miniserver-IP eingeben.',
  'loxone.discoverEmpty': 'Keine Steuerungen gefunden. IP und Zugangsdaten prüfen.',
  'loxone.discoverError': 'Die Liste konnte nicht vom Miniserver geladen werden.',
  'loxone.discoverFound': '{count} Steuerungen gefunden — Block unten auswählen.',
  'devices.username': 'Benutzername',
  'devices.password': 'Passwort',
  'devices.test': 'Verbindung testen',
  'devices.testing': 'Teste…',
  'devices.controlSection': 'Solarsteuerung',
  'devices.onThreshold': 'Einschalten ab Überschuss',
  'devices.offThreshold': 'Ausschalten unter Überschuss',
  'devices.minRuntime': 'Min. Laufzeit',
  'devices.minOfftime': 'Min. Pause',
  ...
  'devices.scheduleEnabled': 'In diesen Zeiten einschalten',
  'devices.editSchedule': 'Zeitplan bearbeiten',
  'devices.scheduleFor': 'Zeitplan — {name}',
  'devices.scheduleHint': 'Füge ein oder mehrere Zeitfenster hinzu. Das Gerät wird in diesen Zeiten EINgeschaltet (z. B. Boiler am Abend warm halten); ausserhalb folgt es dem Solarüberschuss.',
  'devices.guaranteeSection': 'Laufzeit-Garantie',
  'devices.editGuarantee': 'Laufzeit-Garantie bearbeiten',
  'devices.guaranteeFor': 'Laufzeit-Garantie — {name}',
  'devices.reasonLabel': 'Grund',
  'devices.guaranteeHours': 'Mindeststunden',
  'devices.guaranteeRuntime': 'Mindestlaufzeit',
  'devices.unitHours': 'Stunden',
  'devices.unitMinutes': 'Minuten',
  'devices.guaranteeBy': 'Bis Uhrzeit',
  'devices.guaranteeHint': 'Garantiert, dass das Gerät bis zur angegebenen Zeit mindestens so viele Stunden läuft (notfalls aus dem Netz, wenn die Sonne nicht reichte). 0 = aus. Beispiel: Boiler ≥3h bis 18:00.',
  'devices.by': 'bis',
  'devices.todayShort': 'heute',
  'devices.live': 'live',
  'devices.estimated': 'geschätzt',
  ...
  'nav.logout': 'Abmelden',
  'forceChange.title': 'Passwort ändern',
  'forceChange.subtitle': 'Sie verwenden noch das Standardpasswort. Bitte legen Sie ein neues fest, bevor Sie fortfahren.',
  'forceChange.current': 'Aktuelles Passwort',
  'forceChange.new': 'Neues Passwort',
  'forceChange.confirm': 'Neues Passwort bestätigen',
  'forceChange.submit': 'Neues Passwort setzen',
  'forceChange.saving': 'Speichern…',
  'forceChange.tooShort': 'Das neue Passwort muss mindestens 8 Zeichen lang sein.',
  'forceChange.mismatch': 'Die neuen Passwörter stimmen nicht überein.',
  'forceChange.sameAsOld': 'Das neue Passwort muss sich vom aktuellen unterscheiden.',
  'forceChange.failed': 'Passwort konnte nicht geändert werden. Bitte aktuelles Passwort prüfen und erneut versuchen.',
  'nav.autoBilling': 'Auto-Abrechnung',
  'nav.csvUpload': 'CSV-Upload',
  'nav.emailSettings': 'E-Mail',
  'nav.license': 'Lizenz',
  'nav.passwordChange': 'Passwort ändern',

  // License page
  'license.title': 'Lizenz',
  'license.subtitle': 'Verwalten Sie Ihren Plan und aktivieren Sie einen Lizenzschlüssel.',
  ...
  'license.usage': 'Nutzung',
  'license.buildings': 'Gebäude',
  'license.users': 'Benutzer',
  'license.meters': 'Zähler',
  'license.chargers': 'Ladestationen',
  'license.devices': 'Geräte',
  'license.billing': 'Rechnungserstellung',
  'license.included': 'Enthalten',
  'license.notIncluded': 'Nicht enthalten',
  'license.activateTitle': 'Lizenz aktivieren',
  'license.manageKey': 'Lizenzschlüssel',
  'license.activateHint': 'Fügen Sie Ihren erhaltenen Lizenzschlüssel ein, um unbegrenzte Gebäude, Benutzer, Zähler, Ladestationen, Geräte und die Rechnungserstellung freizuschalten.',
  'license.activateButton': 'Aktivieren',
  ...
  // Mieterportal
  'portal.title': 'Mieterportal',
  'portal.loginHint': 'Geben Sie den Zugangscode Ihres Administrators ein',
  'portal.codePlaceholder': 'Zugangscode',
  'portal.signIn': 'Anmelden',
  'portal.signingIn': 'Anmeldung…',
  'portal.invalidCode': 'Ungültiger oder abgelaufener Zugangscode',
  'portal.logout': 'Abmelden',
  'portal.tabInvoices': 'Rechnungen',
  'portal.tabCharging': 'Laden',
  'portal.tabConsumption': 'Verbrauch',
  'portal.tabLive': 'Live',
  'portal.noInvoices': 'Noch keine Rechnungen.',
  'portal.noCharging': 'Noch keine Ladesitzungen.',
  'portal.comingSoon': 'Demnächst verfügbar.',
  'portal.downloadFailed': 'Download fehlgeschlagen',
  'portal.admin.title': 'Portalzugang',
  'portal.admin.desc': 'Teilen Sie diesen privaten Link mit dem Mieter, damit er seine Rechnungen und Ladevorgänge im Self-Service-Portal einsehen kann.',
  'portal.admin.generate': 'Zugangslink erstellen',
  'portal.admin.linkLabel': 'Mieter-Zugangslink',
  'portal.admin.copy': 'Kopieren',
  'portal.admin.copied': 'Kopiert',
  'portal.admin.regenerate': 'Neu erstellen',
  'portal.admin.revoke': 'Widerrufen',
  'portal.admin.revokeConfirm': 'Portalzugang dieses Mieters widerrufen? Der aktuelle Link funktioniert dann nicht mehr.',
  'portal.admin.regenHint': 'Neu erstellen macht den vorherigen Link ungültig. Widerrufen deaktiviert den Portalzugang vollständig.',
  ...
  'dashboard.energyFlowBattery': 'Batterie',
  'dashboard.energyFlowBatteryCharging': 'lädt',
  'dashboard.energyFlowBatteryDischarging': 'entlädt',
  'dashboard.energyFlowBatteryIdle': 'inaktiv',
  ...
  'buildings.energyFlow.battery': 'Batterie',
  'buildings.energyFlow.batteryCharging': 'Lädt',
  'buildings.energyFlow.batteryDischarging': 'Entlädt',
  ...
  'meters.loxonePickBlock': 'Zähler-Block auswählen (füllt die UUID oben)',
  'meters.loxonePickBlockImport': 'Import-Block auswählen (füllt die UUID oben)',
  'meters.loxonePickBlockExport': 'Export-Block auswählen (füllt die Export-UUID oben)',
  ...
  'meters.loxoneModeBatteryBlock': 'Batterieblock (Ladezustand + Laden/Entladen)',
  'meters.loxoneModeBatteryBlockHelp': 'Eine UUID. Laden aus output8 (Mrc), Entladen aus output1 (Mrd), Ladezustand aus output15 (Slvl). Für Batteriezähler.',
  'meters.loxoneBatteryUuid': 'Loxone Batteriezähler UUID (output15/Slvl)',
  ...
  'meters.smartmeAuthTypeHelp': 'Verwenden Sie Ihre Smart-me Kontodaten (Benutzername & Passwort) oder einen API-Schlüssel aus dem Smart-me Dashboard',
  'meters.smartmeAuthApiKey': 'API-Schlüssel (Empfohlen)',
  'meters.smartmeAuthBasic': 'Benutzername & Passwort',
  'meters.smartmeAuthOAuth': 'OAuth 2.0',

  // Smart-me Geräte-Erkennung (alle Zähler nach Eingabe der Zugangsdaten auflisten)
  'meters.smartmeDiscoverTitle': 'Meine Zähler finden',
  'meters.smartmeDiscoverHint': 'Geben Sie oben Ihre Zugangsdaten ein, listen Sie dann alle Zähler Ihres Smart-me Kontos auf und wählen Sie einen aus.',
  'meters.smartmeDiscover': 'Zähler auflisten',
  'meters.smartmeDiscovering': 'Wird geladen…',
  'meters.smartmeDiscoverFound': '{count} Zähler gefunden',
  'meters.smartmeDiscoverEmpty': 'Keine Zähler für diese Zugangsdaten gefunden.',
  'meters.smartmeDiscoverError': 'Zähler konnten nicht aufgelistet werden. Prüfen Sie Ihre Zugangsdaten.',
  'meters.smartmeDiscoverNeedCreds': 'Geben Sie zuerst Ihren API-Schlüssel oder Benutzername & Passwort ein.',
  'meters.smartmePickDevice': 'Zähler aus Ihrem Konto auswählen',
  'meters.smartmeSerial': 'Seriennummer (Ersatz)',
  'meters.smartmeSerialHelp': 'Optional. Wenn Sie die Geräte-ID nicht kennen, geben Sie stattdessen die Seriennummer des Zählers ein — sie wird automatisch aufgelöst.',
  ...
  'chargers.syncZaptecHistory': 'Zaptec-Verlauf synchronisieren',
  'chargers.syncZaptecHistoryDescription': 'Alle Ladesitzungen aus der Zaptec-API für den gewählten Zeitraum abrufen und in die lokale Datenbank schreiben. Eine erneute Synchronisierung mit überlappendem Zeitraum ist unbedenklich — vorhandene Einträge werden behalten oder mit den signierten OCMF-Daten ersetzt, niemals dupliziert.',
  'chargers.syncStart': 'Synchronisieren starten',
  'chargers.syncRunning': 'Synchronisiert …',
  'chargers.syncCompleted': 'Synchronisierung abgeschlossen',
  'chargers.syncFailed': 'Synchronisierung fehlgeschlagen',
  'chargers.syncFetched': 'Abgerufene Sitzungen',
  'chargers.syncOcmf': 'Mit signierten OCMF-Daten geschrieben',
  'chargers.syncFallback': 'Ohne OCMF geschrieben (nur Start/Ende)',
  'chargers.syncSkipped': 'Bereits in der Datenbank',
  'chargers.syncErrors': 'Fehler beim Schreiben',
  ...
  'chargers.loxonePickBlock': 'Ladestation-Block auswählen (füllt die UUID oben)',
  'chargers.loxonePickFor': 'Auswählen für',
  ...
  'chargers.session.solar': 'Solar',
  'chargers.session.grid': 'Netz',
  'chargers.session.splitTitle': 'Solar / Netz Aufteilung',
  'chargers.chargingHistory': 'Ladeverlauf',
  'chargers.history.sessions': 'Sitzungen',
  'chargers.history.empty': 'Noch keine Ladesitzungen aufgezeichnet.',
  'chargers.history.loadFailed': 'Ladeverlauf konnte nicht geladen werden',
  'chargers.history.reconstructed': 'rekonstruiert',
  'chargers.history.backfillHint': 'Aus 15-Minuten-Daten rekonstruiert (vor Einführung der Sitzungserfassung erstellt).',
  'chargers.history.rebuild': 'Neu aufbauen',
  'chargers.history.rebuildConfirm': 'Zeitraum neu aufbauen',
  ...
  'chargers.history.import': 'CSV importieren',
  'chargers.history.importing': 'Importiere…',
  'chargers.history.importDone': '{sessions} Sitzung(en) importiert, {kwh} kWh ({from} → {to}). Nur Zeiträume vor den Live-Daten wurden gefüllt.',
  'chargers.history.importFailed': 'Import fehlgeschlagen',
  'chargers.history.reassignTitle': 'Sitzung neu zuweisen?',
  'chargers.history.reassignBody': 'Diese Sitzung ist derzeit {current} zugewiesen. Auf {new} ändern? Dies aktualisiert auch die Abrechnungsdaten für den Zeitraum dieser Sitzung.',
  'chargers.history.reassignConfirm': 'Ja, neu zuweisen',
  ...
  'billing.reportYear': 'Berichtsjahr',
  'billing.buildingReport': 'Gebäudebericht',
  'billing.vatReport': 'MwSt.-Bericht',
  'billing.reportFailed': 'Bericht konnte nicht heruntergeladen werden',
  'billing.markPaid': 'Als bezahlt markieren',
  'billing.markUnpaid': 'Bezahlt — zum Rückgängigmachen klicken',
  'billing.markedPaid': 'Rechnung als bezahlt markiert',
  'billing.markedUnpaid': 'Rechnung als unbezahlt markiert',
  'billing.paymentUpdateFailed': 'Zahlungsstatus konnte nicht aktualisiert werden',
  ...
  'billConfig.step5.savedProfiles': 'Gespeicherte Absender-/Bankprofile',
  'billConfig.step5.selectProfile': 'Gespeichertes Profil auswählen…',
  'billConfig.step5.profileNamePlaceholder': 'Name zum Speichern der aktuellen Angaben…',
  'billConfig.step5.saveProfile': 'Profil speichern',
  'billConfig.step5.profileSaved': 'Profil gespeichert',
  'billConfig.step5.profileSaveFailed': 'Profil konnte nicht gespeichert werden',
  'billConfig.step5.profileDeleted': 'Profil gelöscht',
  'billConfig.step5.profileDeleteFailed': 'Profil konnte nicht gelöscht werden',
  ...
  'autoBilling.autoEmail.toggle': 'PDF-Rechnung automatisch per E-Mail an den Empfänger senden',
  'autoBilling.autoEmail.description': 'SMTP muss in den E-Mail-Einstellungen konfiguriert sein und der Empfänger benötigt eine E-Mail-Adresse.',
  'autoBilling.editLayout': 'Layout',
  'autoBilling.testRun': 'Jetzt testen',
  'autoBilling.testRunHelp': 'Konfiguration sofort ausführen, um Rechnung und E-Mail-Versand zu prüfen. Der nächste geplante Lauf wird nicht verändert.',
  'autoBilling.testRunRunning': 'Läuft…',
  'autoBilling.testRunConfirm': 'Diese Konfiguration jetzt ausführen? Es wird eine echte Rechnung im System erzeugt und – falls automatischer Versand aktiv ist – an den Empfänger gesendet. Der nächste geplante Lauf bleibt unverändert.',
  'autoBilling.testRunTitle': 'Testlauf',
  'autoBilling.testRunInProgress': 'Rechnung wird erstellt, bitte warten…',
  'autoBilling.testRunInProgressHint': 'Dies kann einige Sekunden dauern. Das PDF wird erstellt und – falls aktiviert – per E-Mail versendet.',
  'autoBilling.testRunSuccess': 'Testlauf erfolgreich abgeschlossen',
  'autoBilling.testRunPartial': 'Testlauf mit Warnungen abgeschlossen',
  'autoBilling.testRunNoBills': 'Es wurden keine Rechnungen erstellt',
  'autoBilling.testRunFailed': 'Testlauf fehlgeschlagen',
  'autoBilling.testRunPeriod': 'Zeitraum',
  'autoBilling.testRunBillsGenerated': 'Rechnungen erstellt',
  'autoBilling.testRunPdfsGenerated': 'PDFs erstellt',
  'autoBilling.testRunEmailsSent': 'E-Mails gesendet',
  'autoBilling.testRunEmailsFailed': 'E-Mails fehlgeschlagen',
  'autoBilling.testRunEmailDisabled': 'Automatischer E-Mail-Versand ist für diese Konfiguration deaktiviert – es wurden keine E-Mails gesendet.',
  'autoBilling.testRunWarnings': 'Warnungen',
  'autoBilling.testRunOpenPDF': 'Erzeugtes PDF öffnen',
  'billLayout.title': 'Rechnungslayout',
  'billLayout.subtitle': 'Hauptseite der Rechnung anpassen. Der QR-Einzahlungsschein bleibt unverändert.',
  'billLayout.building': 'Gebäude',
  'billLayout.noBuildings': 'Keine Gebäude verfügbar',
  'billLayout.qrPageNote': 'Der Schweizer QR-Einzahlungsschein folgt dem offiziellen Standard und kann hier nicht angepasst werden. Nur die Hauptseite der Rechnung wird verändert.',
  'billLayout.titleField': 'Rechnungstitel',
  'billLayout.titlePlaceholder': 'z. B. Stromabrechnung, Jahresabrechnung, Rechnung…',
  'billLayout.titleHelp': 'Leer lassen, um den übersetzten Standardtext "Rechnung" zu verwenden.',
  'billLayout.colorField': 'Akzentfarbe',
  'billLayout.introField': 'Einleitungstext (optional)',
  'billLayout.introPlaceholder': 'Wird oberhalb der Positionen angezeigt.',
  'billLayout.introHelp': 'Begrüssung, Periodenhinweis oder kurze Notiz. Klartext, Zeilenumbrüche bleiben erhalten.',
  'billLayout.footerField': 'Schlusstext (optional)',
  'billLayout.footerPlaceholder': 'Wird unterhalb des Totals angezeigt.',
  'billLayout.footerHelp': 'Zahlungsbedingungen, Kontakt, Dankesnotiz. Klartext, Zeilenumbrüche bleiben erhalten.',
  'billLayout.preview': 'Vorschau',
  'billLayout.previewTitleFallback': 'Rechnung',
  'billLayout.previewPlaceholder': '— Positionen erscheinen hier —',
  'billLayout.reset': 'Auf Standard zurücksetzen',
  'billLayout.saved': 'Layout gespeichert.',
  'billLayout.saveFailed': 'Layout konnte nicht gespeichert werden',
  ...
  'pricing.batteryPower': 'Batterie — Zähler (CHF/kWh)',
  'pricing.batteryPowerDescription': 'Tarif für Batterieenergie, die von Wohnungs-/gemeinsamen Zählern verbraucht wird. Nur bei vorhandenem Batteriezähler.',
  'pricing.batteryCharging': 'Batterie — Autoladen (CHF/kWh)',
  'pricing.batteryChargingDescription': 'Tarif für Batterieenergie, die ins Autoladen fliesst (Solar-Split-Ladestationen).',
  'pricing.solarSplitMode': 'Solar-Verteilung',
  'pricing.solarSplitModeMetered': 'Unter gemessenen Verbrauchern',
  'pricing.solarSplitModeTotal': 'Fair — über gesamten Gebäudeverbrauch',
  'pricing.solarSplitModeMeteredDescription': 'Solar wird nur unter gemessenen Teilnehmern aufgeteilt (Wohnungen, Solar-Split-Ladestationen, solar-tarifierte Zähler). Verbraucher ohne eigenen Zähler werden ignoriert, daher wird gemessenen Verbrauchern etwas mehr Solar gutgeschrieben, als sie physisch erhalten haben.',
  'pricing.solarSplitModeTotalDescription': 'Solar wird über den tatsächlichen Gesamtverbrauch des Gebäudes aufgeteilt, sodass jedes verbrauchte Watt denselben Solaranteil erhält — auch Verbraucher ohne eigenen Zähler. Erfordert einen Gesamt-/Netzzähler; die Solar-/Netzkosten ungemessener Verbraucher werden keinem Mieter belastet (der Gebäude-/ZEV-Eigentümer trägt sie). Fällt für Intervalle ohne Netzdaten auf die gemessene Aufteilung zurück.',
  ...
  'pricing.batteryKwh': 'Batterie · Zähler',
  'pricing.batteryChargingKwh': 'Batterie · Auto',
  ...
  'pricing.vatSection': 'Mehrwertsteuer (MwSt.)',
  'pricing.vatRate': 'MwSt.-Satz',
  'pricing.vatRateDescription': 'Mehrwertsteuersatz in Prozent (z. B. 8.1 für die Schweiz). 0 = keine MwSt. auf der Rechnung.',
  'pricing.vatIncluded': 'MwSt. ist in den Preisen enthalten',
  'pricing.vatIncludedDescription': 'Aktiviert: die oben angegebenen Preise verstehen sich inklusive MwSt. (die Rechnung weist den enthaltenen Betrag aus). Deaktiviert: die MwSt. wird zum Total hinzugerechnet.',
  'pricing.vat': 'MwSt.',
  'pricing.vatInclShort': 'inkl.',
  'pricing.vatExclShort': 'exkl.',
  ...
  'settings.backupsDesc': 'Automatische tägliche Datenbank-Sicherungen',
  'settings.backupNow': 'Jetzt sichern',
  'settings.backupRunning': 'Sichern…',
  'settings.backupNextRun': 'Nächste',
  'settings.backupLastRun': 'Letzte',
  'settings.backupKeep': 'Behält die letzten {n}',
  'settings.backupNone': 'Noch keine Sicherungen.',
  'settings.backupAuto': 'Auto',
  'settings.backupManual': 'Manuell',
  ...
  'settings.smtpFrom': 'Absenderadresse (optional)',
  'settings.smtpFromPlaceholder': 'Standardmässig der SMTP-Benutzername',
  'settings.smtpFromHelp': 'Die angezeigte Absenderadresse. Leer lassen, um den SMTP-Benutzernamen zu verwenden — die meisten Provider verlangen das ohnehin. Nur setzen, wenn ein anderer Anzeige­absender benötigt wird (z. B. ein verifizierter Alias).',
  'settings.alertRecipient': 'Empfänger (Systemmeldungen)',
  'settings.alertRecipientPlaceholder': 'admin@ihredomain.com',
  'settings.alertRecipientHelp': 'Hier landen System-Fehlermeldungen und Gesundheitsberichte. Rechnungen aus der automatischen Abrechnung gehen an die jeweilige E-Mail-Adresse des Mieters – nicht hierher.',
  ...
  'settings.invoiceEmail': 'Rechnungs-E-Mail-Text',
  'settings.invoiceEmailDesc': 'Passen Sie die E-Mail an, die mit der automatischen Rechnung an die Mieter gesendet wird. Lassen Sie beide Felder leer, um den standardmässigen zweisprachigen Text (DE/EN) zu verwenden.',
  'settings.invoiceEmailSubject': 'Betreff',
  'settings.invoiceEmailSubjectPlaceholder': 'z.B. Ihre Rechnung {invoice_number}',
  'settings.invoiceEmailBody': 'Text',
  'settings.invoiceEmailBodyPlaceholder': 'Klartext oder HTML. Leer lassen, um den Standardtext zu verwenden.',
  'settings.invoiceEmailPlaceholders': 'Verfügbare Platzhalter:',
