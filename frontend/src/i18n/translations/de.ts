...
export const de: Translations = {
  ...
  'users.noUsers': 'Keine Benutzer gefunden. Erstellen Sie Ihren ersten Benutzer, um zu beginnen.',
  ...
  'users.regular': 'Normaler Benutzer (Mieter)',
  'users.administration': 'Administrationsbenutzer',
  'users.managedBuildings': 'Verwaltete Gebäude',
  'users.selectManagedBuildings': 'Wählen Sie Gebäude aus, die dieser Administrationsbenutzer verwaltet',
  'users.administrationUsers': 'Administrationsbenutzer',
  'users.regularUsers': 'Normale Benutzer (Mieter)',
  'users.filterByBuilding': 'Nach Gebäude filtern',
  'users.allUsers': 'Alle Benutzer',
  'users.searchUsers': 'Benutzer suchen...',
  'users.noAdminUsers': 'Keine Administrationsbenutzer gefunden.',
  'users.noRegularUsers': 'Keine normalen Benutzer gefunden.',
  'users.adminDescription': 'Administrationsbenutzer erstellen Rechnungen und verwalten mehrere Gebäude',
  'users.regularDescription': 'Normale Benutzer sind Mieter, die in Gebäuden wohnen',
  'users.user': 'Benutzer',
  ...
  'users.rfidNotChargerId': 'Dies ist NICHT eine Ladestations-ID - es ist die Identifikationsnummer der physischen RFID-Karte/Tag.',
  ...
  'users.instructions.regularUserDescription': 'Ein normaler Benutzer (Mieter) ist jemand, der in einem Gebäude wohnt und Zugang zu Ladestationen hat. Sie werden einem bestimmten Gebäude zugewiesen und können ihr Fahrzeug an jeder Ladestation in diesem Gebäude mit ihrer RFID-Karte laden.',
  'users.instructions.whatIsAdminUser': 'Was ist ein Administrationsbenutzer?',
  'users.instructions.adminUserDescription': 'Ein Administrationsbenutzer verwaltet ein oder mehrere Gebäude und ist für die Erstellung von Rechnungen und die Verwaltung von Mietern verantwortlich. Sie haben Zugang zu Abrechnungsinformationen für ihre zugewiesenen Gebäude und können Rechnungen für normale Benutzer erstellen.',
  'users.instructions.howToUse': 'Verwendung',
  'users.instructions.step1': 'Normale Benutzer müssen ein Gebäude zugewiesen haben und eine RFID-Kartennummer',
  'users.instructions.step2': 'Administrationsbenutzer müssen auswählen, welche Gebäude sie verwalten',
  'users.instructions.step3': 'Jeder normale Benutzer kann mehrere RFID-Karten haben (kommagetrennt)',
  'users.instructions.step4': 'Bankverbindung ist optional, aber für die Erstellung von Rechnungen mit QR-Rechnungen erforderlich',
  'users.instructions.step5': 'Verwenden Sie Filter, um Benutzer nach Gebäude zu suchen oder nach Name/E-Mail zu suchen',
  ...
  'users.instructions.tip1': 'Normale Benutzer sind Mieter, die in Gebäuden wohnen und Ladestationen nutzen',
  'users.instructions.tip2': 'Administrationsbenutzer verwalten Gebäude und erstellen Rechnungen für Mieter',
  'users.instructions.tip3': 'Halten Sie RFID-Kartennummern genau, um eine ordnungsgemässe Verfolgung von Ladevorgängen zu gewährleisten',
  'users.status': 'Status',
  ...
  'users.active': 'aktiv',
  'users.archivedUsersSubtitle': 'Inaktive und archivierte Benutzer verwalten',
  'users.showActive': 'Aktive anzeigen',
  'users.showArchive': 'Archiv anzeigen',
  'users.noArchivedAdminUsers': 'Keine archivierten Administrationsbenutzer',
  'users.noArchivedRegularUsers': 'Keine archivierten normalen Benutzer',
  'users.searchPlaceholder': 'Benutzer nach Name, E-Mail oder Wohnung suchen...',
  'users.apartment': 'Wohnung',
  'users.rfidCards': 'RFID-Karte(n)',
  'users.activeUser': 'Aktiver Benutzer',
  'users.inactiveUserNote': 'Inaktive Benutzer werden archiviert und ihre Wohnungen werden verfügbar',
  'users.apartmentUnit': 'Wohnung / Einheit',
  'users.noApartmentAssigned': 'Keine Wohnung zugewiesen',
  'users.current': 'Aktuell',
  'users.onlyAvailableApartments': 'Nur verfügbare Wohnungen werden angezeigt',
  'users.updateFailed': 'Aktualisierung des Benutzerstatus fehlgeschlagen',
  'users.instructions.apartmentsAndStatus': 'Wohnungen & Status',
  'users.instructions.apartmentsAndStatusDescription': 'Benutzer können bestimmten Wohnungen in Gebäuden zugewiesen werden, in denen die Wohnungsverwaltung aktiviert ist. Sie können Benutzer auch als Aktiv oder Inaktiv markieren - inaktive Benutzer werden ins Archiv verschoben und ihre Wohnungen werden verfügbar.',
  'users.instructions.step6': 'Verwenden Sie die Archivansicht, um inaktive Benutzer zu sehen',
  'users.instructions.step7': 'Wohnungen können jeweils nur einen aktiven Benutzer haben',
  'users.instructions.tip4': 'Setzen Sie Benutzer auf inaktiv, anstatt sie zu löschen, um die Historie zu erhalten',
  ...
  'billing.setupInstructions': 'Einrichtungsanleitung',
  'billing.invoiceNumber': 'Rechnung #',
  'billing.user': 'Benutzer',
  'billing.period': 'Zeitraum',
  'billing.amount': 'Betrag',
  'billing.generated': 'Erstellt',
  'billing.noInvoices': 'Noch keine Rechnungen erstellt. Klicken Sie auf "Rechnungen erstellen", um Rechnungen zu generieren.',
  'billing.selectBuildings': 'Gebäude auswählen',
  'billing.atLeastOne': 'mindestens eins',
  ...
  'billing.senderName': 'Absendername / Firma',
  'billing.senderAddress': 'Strassenadresse',
  ...
  'billing.qrNote': 'Wenn Bankdaten angegeben werden, wird eine Schweizer QR-Rechnung auf einer zweiten Seite generiert',
  'billing.swissQR': 'Schweizer QR-Rechnung',
  'billing.reference': 'Referenz',
  'billing.autoFillFromAdmin': 'Automatisch von Administrationsbenutzer ausfüllen',
  'billing.selectAdminUser': 'Wählen Sie einen Administrationsbenutzer aus, um Abrechnungsinformationen automatisch auszufüllen',
  'billing.adminUserFor': 'Administrationsbenutzer für ausgewählte Gebäude',
  'billing.noAdminUserFound': 'Kein Administrationsbenutzer für die ausgewählten Gebäude gefunden',
  'billing.searchBuildings': 'Gebäude suchen...',
  'billing.allBuildings': 'Alle Gebäude',
  'billing.viewFirstWarning': 'Rechnungsposten nicht geladen. Bitte sehen Sie sich zuerst die Rechnung an und laden Sie sie dann herunter.',
  ...
  'billing.instructions.billingDescription': 'Das Abrechnungssystem erstellt automatisch Rechnungen für Mieter basierend auf ihrem Energieverbrauch, Solarproduktionsnutzung und EV-Ladevorgängen. Rechnungen enthalten detaillierte Aufschlüsselungen von Verbrauch und Kosten.',
  ...
  'billing.instructions.work2': 'Solarproduktion wird proportional auf alle Gebäudemieter verteilt',
  'billing.instructions.work3': 'EV-Ladevorgänge werden mit RFID-Karten verfolgt und separat abgerechnet',
  'billing.instructions.work4': 'Rechnungen werden mit Schweizer QR-Rechnungen für einfache Zahlung generiert',
  ...
  'billing.instructions.step3': 'Wählen Sie bestimmte Benutzer aus oder lassen Sie es leer, um für alle Mieter zu generieren',
  ...
  'billing.instructions.step6': 'Überprüfen Sie generierte Rechnungen und laden Sie sie als PDF mit QR-Zahlschein herunter',
  'billing.instructions.important': 'Wichtige Anforderungen',
  'billing.instructions.important1': 'Jedes Gebäude muss vor der Rechnungserstellung aktive Preise konfiguriert haben',
  'billing.instructions.important2': 'Benutzer müssen Wohnungszähler konfiguriert haben, um den Verbrauch zu verfolgen',
  'billing.instructions.important3': 'RFID-Kartennummern müssen für die EV-Ladeverfolgung korrekt konfiguriert sein',
  'billing.instructions.important4': 'Schweizer QR-Rechnungen erfordern gültige IBAN und Bankverbindung',
  'billing.instructions.invoiceContents': 'Rechnungsinhalt',
  'billing.instructions.invoice1': 'Zählerstände zeigen Verbrauchszeitraum',
  'billing.instructions.invoice2': 'Solarstrom vs. Netzstrom Aufschlüsselung',
  'billing.instructions.invoice3': 'EV-Ladevorgänge (Solar- und Prioritätsmodi)',
  'billing.instructions.invoice4': 'Detaillierte Kostenberechnungen mit Tarifen',
  'billing.instructions.invoice5': 'Gesamtbetrag fällig mit Schweizer QR-Rechnung (falls Bankverbindung angegeben)',
  'billing.instructions.tips': 'Tipps',
  'billing.instructions.tip1': 'Erstellen Sie Rechnungen in regelmässigen Abständen (monatlich, vierteljährlich) für Konsistenz',
  'billing.instructions.tip2': 'Überprüfen Sie Zählerdaten vor der Erstellung, um genaue Messwerte sicherzustellen',
  'billing.instructions.tip3': 'Speichern Sie Absender- und Bankverbindung - sie bleiben über Sitzungen hinweg bestehen',
  'billing.instructions.tip4': 'Verwenden Sie die Ansicht-Schaltfläche, um Rechnungen vor dem PDF-Download in der Vorschau anzuzeigen',
