...
export const de: Translations = {
  ...
  'billConfig.step1.selectBuildings': 'Gebäude auswählen ({{count}} ausgewählt)',
  'billConfig.step1.selectUsers': 'Nutzer auswählen ({{count}} ausgewählt)',
  ...
  'billConfig.navigation.generate': '{{count}} Rechnung(en) erstellen',
  ...
  'billConfig.successMessage': '{{count}} Rechnungen erfolgreich erstellt!',
