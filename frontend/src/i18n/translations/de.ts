...
export const de: Translations = {
  ...
  'export.subtitle': '{{type}}-Daten als CSV exportieren',
  ...
  'meters.readingsWillBeDeleted': 'Zählerstände',
  ...
  'meters.deleteFailed': 'Fehler beim Löschen des Zählers. Bitte versuchen Sie es erneut.',

  // Chargers Delete Confirmation
  'chargers.deleteConfirmTitle': 'Ladestation löschen',
  'chargers.deleteWarning': '⚠️ Achtung: Diese Aktion kann nicht rückgängig gemacht werden',
  ...
  'chargers.typeToConfirm': 'Geben Sie den Namen der Ladestation ein, um zu bestätigen:',
  'chargers.typeChargerName': 'Ladestationsname eingeben...',
  'chargers.understandDataLoss': 'Ich verstehe, dass alle Daten unwiderruflich gelöscht werden',
  'chargers.deletePermanently': 'Endgültig löschen',
  ...
  'chargers.deleteFailed': 'Fehler beim Löschen der Ladestation. Bitte versuchen Sie es erneut.',
