...
export const de: Translations = {
  ...
  'buildings.setupInstructions': 'Einrichtungsanleitung',
  ...
  'buildings.energyFlow.production': 'Produktion',
  ...
  'buildings.energyFlow.selling': 'Einspeisung',
  ...
  'buildings.apartmentConfig.enableDescription': 'Konfigurieren Sie Stockwerke und Wohnungen für Mietgebäude',
  ...
  'buildings.apartmentConfig.helpText': 'Klicken Sie auf ein Stockwerk, um Wohnungen hinzuzufügen. Ordnen Sie Stockwerke visuell an. Jede Wohnung kann einem Benutzer zugewiesen werden.',
  ...
  'buildings.instructions.complexDescription': 'Ein Gebäudekomplex ist ein Ordner oder eine Gruppe, die mehrere Gebäude enthält. Verwenden Sie Komplexe, um verwandte Immobilien zu organisieren, z.B. Mehrfamilienhäuser im selben Viertel oder Immobilien desselben Eigentümers.',
  'buildings.instructions.apartmentTitle': 'Wohnungsverwaltung',
  'buildings.instructions.apartmentDescription': 'Aktivieren Sie die Wohnungsverwaltung für Gebäude mit Mieteinheiten. Konfigurieren Sie Stockwerke und Wohnungen visuell mit dem LEGO-artigen Builder. Jede Wohnung kann einem aktiven Benutzer zugewiesen werden.',
  'buildings.instructions.energyFlowTitle': 'Energiefluss-Visualisierung',
  'buildings.instructions.energyFlowDescription': 'Jedes Gebäude zeigt ein Echtzeit-Energieflussdiagramm mit Solarproduktion, Gebäudeverbrauch und Netzinteraktion (Strombezug oder Einspeisung). Das Diagramm wird automatisch alle 15 Minuten aktualisiert.',
  ...
  'buildings.instructions.step2': 'Um einen Komplex zu erstellen, aktivieren Sie "Dies ist ein Gebäudekomplex" und wählen Sie die zugehörigen Gebäude aus',
  'buildings.instructions.step3': 'Aktivieren Sie die Wohnungsverwaltung und bauen Sie Ihre Stockwerksstruktur visuell auf',
  'buildings.instructions.step4': 'Klicken Sie auf eine Komplexkarte, um sie zu erweitern und alle Gebäude darin anzuzeigen',
  'buildings.instructions.step5': 'Jede Gebäudekarte zeigt den Echtzeit-Energiefluss und Verbrauch',
  ...
  'buildings.instructions.tip3': 'Verwenden Sie aussagekräftige Stockwerks- und Wohnungsnamen für eine einfachere Benutzerverwaltung',
  'buildings.instructions.tip4': 'Der visuelle Wohnungsbuilder zeigt Ihre Gebäudestruktur auf einen Blick',
