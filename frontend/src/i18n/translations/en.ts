...
export const en: Translations = {
  ...
  'meters.udpAlternative': 'UDP (Loxone Pushes - Alternative)',
...
'meters.loxoneConnected': 'Loxone Connected',
'meters.loxoneDisconnected': 'Loxone Disconnected',
'meters.loxoneConnecting': 'Connecting to Loxone...',
...
'meters.loxoneHostDescription': 'IP address of your Loxone Miniserver (without http://)',
'meters.loxoneDeviceId': 'Device UUID',
'meters.loxoneDeviceIdDescription': 'UUID of the virtual output in Loxone (find it in Loxone Config)',
'meters.loxoneUsername': 'Username',
'meters.loxonePassword': 'Password',
'meters.loxoneCredentialsDescription': 'Loxone Miniserver credentials for WebSocket authentication',
'meters.loxoneApiDescription': 'Real-time WebSocket connection with online/offline status',

// Loxone Setup Guide
'meters.loxoneSetupGuide': 'What you need from Loxone Config:',
'meters.loxoneSetupStep1': '1. Find your Virtual Output in the program tree',
'meters.loxoneSetupStep2': '2. Right-click → Properties → Copy the UUID',
'meters.loxoneSetupStep3': '3. The system will read output1.value (kWh) from this device',
'meters.loxoneSetupStep4': '4. Connection status will be shown on the meter card (🟢 online / 🔴 offline)',

// Loxone Features
'meters.loxoneFeatures': 'Features:',
'meters.loxoneFeature1': '✓ Real-time updates via WebSocket',
'meters.loxoneFeature2': '✓ Automatic reconnection on disconnects',
'meters.loxoneFeature3': '✓ Visual online/offline status indicator',

// UDP Warnings
'meters.udpDeprecatedWarning': '⚠️ UDP is deprecated - Use Loxone WebSocket API for best results',
'meters.dataKeyModifiable': 'You can modify the UUID if needed',
'meters.dataKeyAutoGenerated': 'Auto-generated unique identifier (UUID_power_kwh format)',
'meters.loxoneConfiguration': 'Loxone Configuration:',
'meters.udpVirtualOutput': 'Virtual Output UDP to',
...
'meters.instructions.loxoneRecommended': 'RECOMMENDED - Best method with real-time connection and status monitoring',
'meters.instructions.loxoneStep1': 'Select "Loxone WebSocket API" as connection type',
'meters.instructions.loxoneStep2': 'Enter your Loxone Miniserver IP address (e.g., 192.168.1.100)',
'meters.instructions.loxoneStep3': 'Find the Virtual Output UUID in Loxone Config (right-click → Properties)',
'meters.instructions.loxoneStep4': 'Enter Loxone username and password (optional but recommended)',
'meters.instructions.loxoneStep5': 'Save - the system will automatically connect via WebSocket',
'meters.instructions.loxoneExample': 'Example Configuration:',
...
'meters.instructions.loxoneExampleCredentials': 'Username: admin / Password: ••••••••',
'meters.instructions.loxoneBenefits': 'Benefits:',
'meters.instructions.loxoneBenefit1': '✓ Real-time WebSocket updates every 15 minutes',
'meters.instructions.loxoneBenefit2': '✓ Automatic reconnection on network issues',
'meters.instructions.loxoneBenefit3': '✓ Live connection status (🟢 online / 🔴 offline)',

// Instructions Modal - Updated UDP Section
'meters.instructions.udpDeprecated': '⚠️ DEPRECATED - Use Loxone WebSocket API instead for better reliability',

// Instructions Modal - Troubleshooting
'meters.instructions.troubleshootingLoxoneWebSocket': 'Check if Loxone Miniserver is reachable on the network',
'meters.instructions.troubleshootingLoxoneAuth': 'Verify username and password are correct',
'meters.instructions.troubleshootingLoxoneDevice': 'Ensure Device UUID is correct (copy from Loxone Config)',
};