...
export const en: Translations = {
  ...
  'users.active': 'active',
  'users.archivedUsersSubtitle': 'Manage inactive and archived users',
  ...
  'users.searchPlaceholder': 'Search users by name, email, or apartment...',
  'users.apartment': 'Apartment',
  'users.rfidCards': 'RFID Card(s)',
  'users.activeUser': 'Active User',
  'users.inactiveUserNote': 'Inactive users are archived and their apartments become available',
  'users.apartmentUnit': 'Apartment / Unit',
  'users.noApartmentAssigned': 'No apartment assigned',
  'users.current': 'Current',
  'users.onlyAvailableApartments': 'Only available apartments are shown',
  'users.updateFailed': 'Failed to update user status',
  'users.instructions.apartmentsAndStatus': 'Apartments & Status',
  'users.instructions.apartmentsAndStatusDescription': 'Users can be assigned to specific apartments in buildings that have apartment management enabled. You can also mark users as Active or Inactive - inactive users are moved to the archive and their apartments become available.',
  'users.instructions.step6': 'Use the Archive view to see inactive users',
  'users.instructions.step7': 'Apartments can only have one active user at a time',
  'users.instructions.tip4': 'Set users to inactive instead of deleting them to preserve history',
