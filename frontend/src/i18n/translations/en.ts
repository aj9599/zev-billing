...
export const en: Translations = {
  ...
  'billConfig.step1.selectBuildings': 'Select Buildings ({{count}} selected)',
  'billConfig.step1.selectUsers': 'Select Users ({{count}} selected)',
  ...
  'billConfig.navigation.generate': 'Generate {{count}} Invoice(s)',
  ...
  'billConfig.successMessage': 'Successfully generated {{count}} invoices!',
