...
export const en: Translations = {
  // ============================================================================
  // E3/DC HAUSKRAFTWERK (meters, charger, device)
  // ============================================================================
  'meters.e3dcIntro': 'Reads one value from an E3/DC EMS. Power is integrated into cumulative energy for billing. Modbus (port 502) is read-only and needs no login; RSCP (port 5033) also works and is required for wallbox readings.',
  'meters.e3dcProtocol': 'Protocol',
  'meters.e3dcProtocolModbus': 'Modbus TCP (read-only)',
  'meters.e3dcProtocolRscp': 'RSCP (encrypted)',
  'meters.e3dcValue': 'Value',
  'meters.e3dcValueGrid': 'Grid (import / export)',
  'meters.e3dcValuePv': 'PV production',
  ...
  'meters.e3dcUser': 'Portal user (myE3DC e-mail)',
  'meters.e3dcPassword': 'Portal password',
  'meters.e3dcRscpKey': 'RSCP key',
  'meters.e3dcRscpKeyHint': 'Set on the device under Personalize → User profile (the encryption key, not the portal password).',
  'meters.e3dcUnitId': 'Modbus unit ID',
  'meters.e3dcUnitIdHint': 'Enable Modbus/TCP in the E3/DC settings first. Wallbox readings require RSCP.',
  'meters.e3dcExternalPower': 'Subtract additional feed-in (second inverter)',
  'meters.e3dcConnected': 'E3/DC Connected',
  'meters.e3dcDisconnected': 'E3/DC Disconnected',
  'meters.e3dcConnecting': 'E3/DC Connecting…',
  'meters.e3dcSoc': 'Charge',
  'meters.e3dcCharging': 'charging',
  ...
  'chargers.e3dcUser': 'Portal user (myE3DC e-mail)',
  'chargers.e3dcPassword': 'Portal password',
  'chargers.e3dcRscpKey': 'RSCP key',
  'chargers.e3dcRscpKeyHint': 'Set on the device under Personalize → User profile. This is the encryption key, NOT the portal password.',
  'devices.e3dcInfo': 'Controls the E3/DC integrated wallbox over RSCP — “on” enables charging, “off” stops it. Disable Sun Mode & Auto Phase Switching in the E3/DC portal so this app can steer it.',
  'devices.e3dcRscpKey': 'RSCP key',
  'devices.e3dcDynamic': 'Dynamic solar charging',
  'devices.e3dcDynamicHint': 'Continuously matches the wallbox current to the available solar surplus instead of simple on/off. In Auto mode it follows the sun; On = charge at max, Off = stop.',
  ...
  'devices.setupInstructions': 'Setup Instructions',
  'devices.instructions.title': 'Device Setup Instructions',
  'devices.instructions.intro': 'Devices switch external relays from your live solar surplus. Add a Shelly or Loxone relay, set when it should turn on, and the system drives it automatically in Auto mode.',
  'devices.instructions.shellyTitle': 'Shelly relay',
  'devices.instructions.shellyText': 'Pick your exact Shelly model, then enter its IP address (and a username/password if you set one). PM models also report live power and energy on the card.\nMulti-relay models (Pro 2/3/4PM) can run as a single relay, or in "Staged" mode: define stages where each stage turns more relays on as the surplus grows (e.g. a boiler: stage 1 = 2 relays at 2 kW, stage 2 = all 3 relays at 4 kW).',
  'devices.instructions.loxoneTitle': 'Loxone relay',
  'devices.instructions.loxoneText': 'Enter the Miniserver IP and your credentials, then use "Load from Miniserver" to pick the output by name instead of typing a UUID. The card shows the real switch state read back from Loxone.',
  'devices.instructions.controlTitle': 'Control & thresholds',
  'devices.instructions.controlText': 'Set the On threshold (surplus needed to switch on) and Off threshold (hysteresis). Priority decides which device gets the surplus first; min on/off times prevent rapid switching. Use the On / Off / Auto buttons to override — schedule and runtime guarantee only act in Auto.',
  'devices.instructions.scheduleTitle': 'Schedule',
  'devices.instructions.scheduleText': 'Optional time windows force the device on regardless of sun (e.g. keep a boiler warm 18:00–23:00). Only active in Auto mode.',
  'devices.instructions.guaranteeTitle': 'Runtime guarantee',
  'devices.instructions.guaranteeText': 'Guarantee a minimum runtime (in hours or minutes) by a deadline each day. If the sun did not provide enough, the device runs from the grid late enough to still reach the required time. Only active in Auto mode.',
  ...
  'devices.controlError': 'Could not send the command to the device.',
  'devices.confirmDelete': 'Delete device "{name}"?',
  'devices.online': 'Online',
  'devices.offline': 'Offline',
  'devices.noSignal': 'No grid signal',
  'devices.state.on': 'On',
  'devices.state.off': 'Off',
  'devices.state.offline': 'Offline',
  'devices.state.unknown': 'Unknown',
  'devices.mode.auto': 'Auto',
  'devices.mode.on': 'Manual on',
  'devices.mode.off': 'Manual off',
  'devices.modeLabel': 'Mode',
  'devices.deviceShort': 'Device',
  'devices.controlShort': 'Control',
  ...
  'devices.driver': 'Device type',
  'devices.connection': 'Connection',
  'devices.host': 'IP address / host',
  'devices.generation': 'Generation',
  'devices.shellyModel': 'Shelly model',
  'devices.channel': 'Channel',
  'devices.relay': 'Relay',
  'devices.devicePower': 'Power',
  'devices.shellyControlMode': 'Relay control',
  'devices.shellySingle': 'Single relay',
  'devices.shellyStaged': 'Staged',
  'devices.stages': 'Stages',
  'devices.stage': 'Stage',
  'devices.stageOnThreshold': 'On ≥ (W)',
  'devices.stageOffThreshold': 'Off < (W)',
  'devices.addStage': 'Add stage',
  'devices.stagesHint': 'Stages are cumulative power levels. Pick which relays are ON at each stage; a stage turns on when surplus reaches its On threshold and drops below its Off threshold. Order them from lowest to highest threshold.',
  'devices.authUser': 'Username',
  'devices.authPass': 'Password',
  'devices.outputUuid': 'Output UUID',
  'devices.discover': 'Load devices from Miniserver',
  'devices.discovering': 'Loading…',
  'devices.pickOutput': 'Pick an output',
  'devices.discoverNeedHost': 'Enter the Miniserver IP first.',
  'devices.discoverEmpty': 'No switchable outputs found.',
  'devices.discoverError': 'Could not load devices from the Miniserver.',
  // Loxone auto-discovery (meters & chargers)
  'loxone.discoverTitle': 'Auto-discovery',
  'loxone.discoverHint': 'Enter the Miniserver IP and your credentials above, then load the list and pick your block by name — no need to look up the UUID by hand.',
  'loxone.discoverHost': 'Miniserver IP',
  'loxone.discover': 'Load from Miniserver',
  'loxone.discovering': 'Loading…',
  'loxone.discoverNeedHost': 'Enter the Miniserver IP first.',
  'loxone.discoverEmpty': 'No controls found. Check the IP and credentials.',
  'loxone.discoverError': 'Could not load the list from the Miniserver.',
  'loxone.discoverFound': '{count} controls found — pick your block below.',
  'devices.username': 'Username',
  'devices.password': 'Password',
  'devices.test': 'Test connection',
  'devices.testing': 'Testing…',
  'devices.controlSection': 'Solar control',
  'devices.onThreshold': 'Switch on above surplus',
  'devices.offThreshold': 'Switch off below surplus',
  'devices.minRuntime': 'Min. runtime',
  'devices.minOfftime': 'Min. off-time',
  ...
  'devices.scheduleEnabled': 'Turn on during these times',
  'devices.editSchedule': 'Edit schedule',
  'devices.scheduleFor': 'Schedule — {name}',
  'devices.scheduleHint': 'Add one or more time windows. The device is switched ON during these times (e.g. keep a boiler warm in the evening); outside them it follows solar surplus.',
  'devices.guaranteeSection': 'Runtime guarantee',
  'devices.editGuarantee': 'Edit runtime guarantee',
  'devices.guaranteeFor': 'Runtime guarantee — {name}',
  'devices.reasonLabel': 'Reason',
  'devices.guaranteeHours': 'Minimum hours',
  'devices.guaranteeRuntime': 'Minimum runtime',
  'devices.unitHours': 'Hours',
  'devices.unitMinutes': 'Minutes',
  'devices.guaranteeBy': 'By time',
  'devices.guaranteeHint': 'Guarantee the device runs at least this many hours by the given time (topping up from the grid if solar was not enough). 0 = off. Example: boiler ≥3h by 18:00.',
  'devices.by': 'by',
  'devices.todayShort': 'today',
  'devices.live': 'live',
  'devices.estimated': 'est.',
  ...
  'nav.logout': 'Logout',
  'forceChange.title': 'Change your password',
  'forceChange.subtitle': 'You are still using the default password. Please set a new one before continuing.',
  'forceChange.current': 'Current password',
  'forceChange.new': 'New password',
  'forceChange.confirm': 'Confirm new password',
  'forceChange.submit': 'Set new password',
  'forceChange.saving': 'Saving…',
  'forceChange.tooShort': 'New password must be at least 8 characters.',
  'forceChange.mismatch': 'The new passwords do not match.',
  'forceChange.sameAsOld': 'New password must be different from the current one.',
  'forceChange.failed': 'Could not change the password. Check your current password and try again.',
  ...
  'license.subtitle': 'Manage your plan and activate a license key.',
  ...
  'license.usage': 'Usage',
  'license.buildings': 'Buildings',
  'license.users': 'Users',
  'license.meters': 'Meters',
  'license.chargers': 'Chargers',
  'license.devices': 'Devices',
  'license.billing': 'Bill generation',
  'license.included': 'Included',
  'license.notIncluded': 'Not included',
  'license.activateTitle': 'Activate a license',
  'license.manageKey': 'License key',
  'license.activateHint': 'Paste the license key you received to unlock unlimited buildings, users, meters, chargers, devices and bill generation.',
  'license.activateButton': 'Activate',
  ...
  'portal.loginHint': 'Enter the access code from your administrator',
  'portal.codePlaceholder': 'Access code',
  'portal.signIn': 'Sign in',
  'portal.signingIn': 'Signing in…',
  'portal.invalidCode': 'Invalid or expired access code',
  'portal.logout': 'Log out',
  'portal.tabInvoices': 'Invoices',
  'portal.tabCharging': 'Charging',
  'portal.tabConsumption': 'Consumption',
  'portal.tabLive': 'Live',
  'portal.noInvoices': 'No invoices yet.',
  'portal.noCharging': 'No charging sessions yet.',
  'portal.comingSoon': 'Coming soon.',
  'portal.downloadFailed': 'Download failed',
  'portal.admin.title': 'Portal access',
  'portal.admin.desc': 'Share this private link with the tenant so they can view their invoices and charging in the self-service portal.',
  'portal.admin.generate': 'Generate access link',
  'portal.admin.linkLabel': 'Tenant access link',
  'portal.admin.copy': 'Copy',
  'portal.admin.copied': 'Copied',
  'portal.admin.regenerate': 'Regenerate',
  'portal.admin.revoke': 'Revoke',
  'portal.admin.revokeConfirm': 'Revoke this tenant’s portal access? Their current link will stop working.',
  'portal.admin.regenHint': 'Regenerating invalidates the previous link. Revoking disables portal access entirely.',
  ...
  'dashboard.energyFlowBattery': 'Battery',
  'dashboard.energyFlowBatteryCharging': 'charging',
  'dashboard.energyFlowBatteryDischarging': 'discharging',
  'dashboard.energyFlowBatteryIdle': 'idle',
  ...
  'dashboard.energyFlowLiveUpdating': 'Updating every 15s',
  'dashboard.energyFlowNoPower': 'No power',
  ...
  'meters.loxonePickBlock': 'Pick meter block (fills the UUID above)',
  'meters.loxonePickBlockImport': 'Pick import block (fills the UUID above)',
  'meters.loxonePickBlockExport': 'Pick export block (fills the export UUID above)',
  ...
  'meters.loxoneModeBatteryBlock': 'Battery Block (SoC + Charge/Discharge)',
  'meters.loxoneModeBatteryBlockHelp': 'One UUID. Charge from output8 (Mrc), discharge from output1 (Mrd), state of charge from output15 (Slvl). For battery meters.',
  'meters.loxoneBatteryUuid': 'Loxone Battery Meter UUID (output15/Slvl)',
  ...
  'meters.smartmeAuthTypeHelp': 'Use your Smart-me account login (username & password), or an API key from the Smart-me dashboard',
  'meters.smartmeAuthApiKey': 'API Key (Recommended)',
  'meters.smartmeAuthBasic': 'Username & Password',
  'meters.smartmeAuthOAuth': 'OAuth 2.0',

  // Smart-me device discovery (list all meters after entering credentials)
  'meters.smartmeDiscoverTitle': 'Find my meters',
  'meters.smartmeDiscoverHint': 'Enter your credentials above, then list every meter on your Smart-me account and pick one.',
  'meters.smartmeDiscover': 'List meters',
  'meters.smartmeDiscovering': 'Loading…',
  'meters.smartmeDiscoverFound': '{count} meter(s) found',
  'meters.smartmeDiscoverEmpty': 'No meters found for these credentials.',
  'meters.smartmeDiscoverError': 'Could not list meters. Check your credentials.',
  'meters.smartmeDiscoverNeedCreds': 'Enter your API key or username & password first.',
  'meters.smartmePickDevice': 'Pick a meter from your account',
  'meters.smartmeSerial': 'Serial Number (backup)',
  'meters.smartmeSerialHelp': 'Optional. If you do not know the device ID, enter the meter serial number instead — it is resolved automatically.',
  ...
  'chargers.syncZaptecHistory': 'Sync Zaptec history',
  'chargers.syncZaptecHistoryDescription': 'Pull every charging session from the Zaptec API for the chosen date range and write it into the local database. Re-running the sync for an overlapping range is safe — existing rows are kept or upgraded with the signed OCMF reading, never duplicated.',
  'chargers.syncStart': 'Start sync',
  'chargers.syncRunning': 'Syncing…',
  'chargers.syncCompleted': 'Sync completed',
  'chargers.syncFailed': 'Sync failed',
  'chargers.syncFetched': 'Sessions fetched',
  'chargers.syncOcmf': 'Written with signed OCMF data',
  'chargers.syncFallback': 'Written without OCMF (start/end only)',
  'chargers.syncSkipped': 'Already in database',
  'chargers.syncErrors': 'Failed to write',
  ...
  'chargers.loxonePickBlock': 'Pick charger block (fills the UUID above)',
  'chargers.loxonePickFor': 'Pick for',
  ...
  'chargers.session.grid': 'Grid',
  'chargers.session.splitTitle': 'Solar / grid split',
  'chargers.chargingHistory': 'Charging history',
  'chargers.history.sessions': 'sessions',
  'chargers.history.empty': 'No charging sessions recorded yet.',
  'chargers.history.loadFailed': 'Failed to load charging history',
  'chargers.history.reconstructed': 'reconstructed',
  'chargers.history.backfillHint': 'Reconstructed from 15-minute records (created before per-session capture was available).',
  'chargers.history.rebuild': 'Rebuild',
  'chargers.history.rebuildConfirm': 'Rebuild range',
  ...
  'chargers.history.import': 'Import CSV',
  'chargers.history.importing': 'Importing…',
  'chargers.history.importDone': 'Imported {sessions} session(s), {kwh} kWh ({from} → {to}). Only periods before live data were filled.',
  'chargers.history.importFailed': 'Import failed',
  'chargers.history.reassignTitle': 'Reassign this session?',
  'chargers.history.reassignBody': 'This session is currently assigned to {current}. Change it to {new}? This also updates the billing records for this session’s time period.',
  'chargers.history.reassignConfirm': 'Yes, reassign',
  ...
  "chargers.loxoneUuidMode": "Loxone UUID Mode",
  "chargers.loxoneUuidModeMulti": "Multi UUID (4 separate UUIDs)",
  ...
  'billing.reportYear': 'Report year',
  'billing.buildingReport': 'Building report',
  'billing.vatReport': 'VAT report',
  'billing.reportFailed': 'Failed to download report',
  'billing.markPaid': 'Mark as paid',
  'billing.markUnpaid': 'Paid — click to undo',
  'billing.markedPaid': 'Invoice marked as paid',
  'billing.markedUnpaid': 'Invoice marked as unpaid',
  'billing.paymentUpdateFailed': 'Failed to update payment status',
  ...
  'billConfig.step5.savedProfiles': 'Saved sender / banking profiles',
  'billConfig.step5.selectProfile': 'Select a saved profile…',
  'billConfig.step5.profileNamePlaceholder': 'Name to save current details as…',
  'billConfig.step5.saveProfile': 'Save profile',
  'billConfig.step5.profileSaved': 'Profile saved',
  'billConfig.step5.profileSaveFailed': 'Failed to save profile',
  'billConfig.step5.profileDeleted': 'Profile deleted',
  'billConfig.step5.profileDeleteFailed': 'Failed to delete profile',
  ...
  'billConfig.step5.country': 'Country',
  ...
  'autoBilling.autoEmail.toggle': 'Email the PDF invoice to the recipient automatically',
  'autoBilling.autoEmail.description': 'Requires SMTP to be configured in Email Settings and the recipient user to have an email address.',
  'autoBilling.editLayout': 'Layout',
  'autoBilling.testRun': 'Test now',
  'autoBilling.testRunHelp': 'Run this configuration immediately to verify the bill and email delivery. Does not change the next scheduled run.',
  'autoBilling.testRunRunning': 'Running…',
  'autoBilling.testRunConfirm': 'Run this configuration now? This will generate a real invoice in the system and, if auto-email is enabled, send it to the recipient. The next scheduled run is not affected.',
  'autoBilling.testRunTitle': 'Test Run',
  'autoBilling.testRunInProgress': 'Generating bill, please wait…',
  'autoBilling.testRunInProgressHint': 'This may take a few seconds. The PDF is being generated and — if enabled — emailed to the recipient.',
  'autoBilling.testRunSuccess': 'Test run completed successfully',
  'autoBilling.testRunPartial': 'Test run completed with warnings',
  'autoBilling.testRunNoBills': 'No bills were generated',
  'autoBilling.testRunFailed': 'Test run failed',
  'autoBilling.testRunPeriod': 'Period',
  'autoBilling.testRunBillsGenerated': 'Bills generated',
  'autoBilling.testRunPdfsGenerated': 'PDFs created',
  'autoBilling.testRunEmailsSent': 'Emails sent',
  'autoBilling.testRunEmailsFailed': 'Emails failed',
  'autoBilling.testRunEmailDisabled': 'Auto-email is disabled for this configuration — no emails were sent.',
  'autoBilling.testRunWarnings': 'Warnings',
  'autoBilling.testRunOpenPDF': 'Open generated PDF',
  'billLayout.title': 'Bill Layout',
  'billLayout.subtitle': 'Customise the main invoice page. The QR-bill payment slip is left untouched.',
  'billLayout.building': 'Building',
  'billLayout.noBuildings': 'No buildings available',
  'billLayout.qrPageNote': 'The Swiss QR-bill payment slip is governed by the official standard and cannot be customised here. Only the main invoice page is affected.',
  'billLayout.titleField': 'Invoice title',
  'billLayout.titlePlaceholder': 'e.g. Stromabrechnung, Yearly Statement, Invoice…',
  'billLayout.titleHelp': 'Leave empty to use the default translated word for "Invoice".',
  'billLayout.colorField': 'Accent colour',
  'billLayout.introField': 'Intro text (optional)',
  'billLayout.introPlaceholder': 'Shown above the line items.',
  'billLayout.introHelp': 'A greeting, period summary, or any short note. Plain text; line breaks preserved.',
  'billLayout.footerField': 'Footer text (optional)',
  'billLayout.footerPlaceholder': 'Shown below the totals.',
  'billLayout.footerHelp': 'Payment terms, contact, thank-you note. Plain text; line breaks preserved.',
  'billLayout.preview': 'Preview',
  'billLayout.previewTitleFallback': 'Invoice',
  'billLayout.previewPlaceholder': '— line items appear here —',
  'billLayout.reset': 'Reset to defaults',
  'billLayout.saved': 'Layout saved.',
  'billLayout.saveFailed': 'Failed to save layout',
  ...
  'pricing.batteryPower': 'Battery — Meters (CHF/kWh)',
  'pricing.batteryPowerDescription': 'Tariff for battery energy consumed by apartment/shared meters. Only applied when the building has a battery meter.',
  'pricing.batteryCharging': 'Battery — EV Charging (CHF/kWh)',
  'pricing.batteryChargingDescription': 'Tariff for battery energy that goes into EV charging (solar-split chargers).',
  'pricing.solarSplitMode': 'Solar distribution',
  'pricing.solarSplitModeMetered': 'Among metered consumers',
  'pricing.solarSplitModeTotal': 'Fair — across total building usage',
  'pricing.solarSplitModeMeteredDescription': 'Solar is shared only among metered participants (apartments, solar-split chargers, solar-priced meters). Loads without their own meter are ignored, so metered consumers get credited slightly more solar than they physically received.',
  'pricing.solarSplitModeTotalDescription': 'Solar is split across the building’s true total consumption, so every consumed Watt draws the same solar share — including loads without their own meter. Requires a total/grid meter; the solar/grid cost of unmetered loads is not billed to any tenant (the building/ZEV owner absorbs it). Falls back to the metered split for any interval without grid data.',
  ...
  'pricing.batteryKwh': 'Battery · Meters',
  'pricing.batteryChargingKwh': 'Battery · EV',
  ...
  'pricing.vatSection': 'Value Added Tax (VAT)',
  'pricing.vatRate': 'VAT Rate',
  'pricing.vatRateDescription': 'VAT rate in percent (e.g. 8.1 for Switzerland). 0 = no VAT shown on the invoice.',
  'pricing.vatIncluded': 'VAT is included in the prices',
  'pricing.vatIncludedDescription': 'Enabled: the prices above are inclusive of VAT (the invoice shows the contained amount). Disabled: VAT is added on top of the total.',
  'pricing.vat': 'VAT',
  'pricing.vatInclShort': 'incl.',
  'pricing.vatExclShort': 'excl.',
  ...
  'settings.backupsDesc': 'Automatic daily database snapshots',
  'settings.backupNow': 'Backup now',
  'settings.backupRunning': 'Backing up…',
  'settings.backupNextRun': 'Next',
  'settings.backupLastRun': 'Last',
  'settings.backupKeep': 'Keeps the last {n}',
  'settings.backupNone': 'No backups yet.',
  'settings.backupAuto': 'Auto',
  'settings.backupManual': 'Manual',
  ...
  'settings.emailAlertsDesc': 'Receive email alerts for errors and periodic system health reports',
  ...
  'settings.smtpUserPlaceholder': 'your-email@example.com',
  'settings.smtpPassword': 'SMTP Password',
  'settings.smtpPasswordPlaceholder': 'App password or SMTP password',
  'settings.smtpFrom': 'From Address (optional)',
  'settings.smtpFromPlaceholder': 'Defaults to SMTP Username',
  'settings.smtpFromHelp': 'The address shown as the sender. Leave empty to use the SMTP Username — most providers require this anyway. Set it only if you need a different display address (e.g. a verified alias).',
  'settings.alertRecipient': 'Alert Recipient',
  'settings.alertRecipientPlaceholder': 'admin@yourdomain.com',
  'settings.alertRecipientHelp': 'Where system error alerts and health reports are sent. Bills generated via the auto-billing module are sent to each tenant\'s own email address — not here.',
  'settings.errorAlerts': 'Error Alerts',
  'settings.enableErrorAlerts': 'Enable Error Alerts',
  'settings.enableErrorAlertsDesc': 'Send email when system errors are detected',
  'settings.rateLimitMinutes': 'Digest Interval (minutes)',
  'settings.rateLimitDesc': 'Minimum time between alert emails',
  'settings.healthReports': 'Health Reports',
  'settings.enableHealthReports': 'Enable Health Reports',
  'settings.enableHealthReportsDesc': 'Send periodic system health summary emails',
  'settings.healthFrequency': 'Frequency',
  'settings.healthFrequencyWeekly': 'Weekly',
  'settings.healthFrequencyMonthly': 'Monthly',
  'settings.healthFrequencyCustom': 'Custom (days)',
  'settings.healthDay': 'Day',
  'settings.healthDayOfWeek': 'Day of Week',
  'settings.healthDayOfMonth': 'Day of Month',
  'settings.healthIntervalDays': 'Interval (days)',
  'settings.healthHour': 'Hour',
  'settings.testEmail': 'Send Test Email',
  'settings.testEmailSending': 'Sending...',
  'settings.testEmailSuccess': 'Test email sent successfully!',
  'settings.testEmailFailed': 'Failed to send test email',
  'settings.testHealthReport': 'Send Health Report Now',
  'settings.testHealthReportSending': 'Sending...',
  'settings.testHealthReportSuccess': 'Health report sent successfully!',
  'settings.testHealthReportFailed': 'Failed to send health report',
  'settings.invoiceEmail': 'Invoice Email Text',
  'settings.invoiceEmailDesc': 'Customise the email sent to tenants with their automatic invoice. Leave both fields empty to use the default bilingual (DE/EN) text.',
  'settings.invoiceEmailSubject': 'Subject',
  'settings.invoiceEmailSubjectPlaceholder': 'e.g. Your invoice {invoice_number}',
  'settings.invoiceEmailBody': 'Body',
  'settings.invoiceEmailBodyPlaceholder': 'Plain text or HTML. Leave empty to use the default text.',
  'settings.invoiceEmailPlaceholders': 'Available placeholders:',
  'settings.saveEmailSettings': 'Save Settings',
  'settings.emailSettingsSaved': 'Email settings saved successfully!',
  'settings.emailSettingsFailed': 'Failed to save email settings',
  'settings.lastAlertSent': 'Last alert sent',
  'settings.lastHealthReportSent': 'Last health report sent',
  'settings.neverSent': 'Never',
